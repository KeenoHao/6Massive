...
// 添加关键词
func (root *node) AddWord(word string, tag uint8) bool {
...
func (root *node) Search(ws []rune) (start int, end int, tag uint8, autoReplace bool, wildcards []int) {
